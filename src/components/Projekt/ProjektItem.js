...
export default function ProjektItem() {
    const ProjektData = [
        {
            staticImage: "./image/tomorrowsFilmwork.jpg",
            gifImage: "./image/tomorrowsFilmwork.gif",
        ...
        {
            staticImage: "./image/portfolioV2.jpg",
            gifImage: "./image/portfolioV2.gif",
        ...
        {
            staticImage: "./image/portfolio.jpg",
            gifImage: "./image/portfolio.gif",
            titel: "PORTFOLIO",
            text: [
        ...
        {
            staticImage: "./image/commingSoon.png",
            gifImage: "./image/commingSoon.png",
            titel: "LANDING PAGE",
            text: [
        ...
        <div className="container mt-4 containerProjekt">
            {ProjektData.map((item, index) => (
                <div className="row d-flex align-items-center mb-50" key={index}>
                    <HoverImage
                        staticSrc={item.staticImage}
                        gifSrc={item.gifImage}
                        link={item.link}
                    />
                    <div className="col-md-6 d-flex flex-column text-white">
                        <h3 className="my-3 d-flex flex-column align-items-center">
                            {item.titel}
                        </h3>
                        {item.text.map((line, i) => (
                            <p className="text-r" key={i}>
                                {line}
                            </p>
                        ))}
